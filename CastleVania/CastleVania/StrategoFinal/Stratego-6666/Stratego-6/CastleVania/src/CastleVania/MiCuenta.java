...
public class MiCuenta extends javax.swing.JFrame {
     ...
     */
    public MiCuenta(int UserIndex, ArrayList UsuariosObtenidos, ArrayList<Logs> Todoslos_Logs_A) {
        indexUser = UserIndex;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 240, 229, 47));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Nombre: ");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 50, 330, 180));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 420, 160, 30));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 300, 230, 50));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 360, 230, 50));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/crearPlayer.png"))); // NOI18N
...
if(Usuarios.get(indexUser).getContra().equals(Contra) &&Usuarios.get(indexUser).isActivo() ){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MiCuenta(-1, null,null).setVisible(true);
            }
        });
    }
